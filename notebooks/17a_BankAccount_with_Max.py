...
class BankAccount:
    def __init__(self, amount=0):
        self._balance = max(0, amount)  # Ensure non-negative balance

    @property
    def balance(self):
        return max(0, self._balance)  # Enforce non-negative on read
...
account_1.test()
account_2.test()  # Output: 100
account_3.test()  # Output: 0
